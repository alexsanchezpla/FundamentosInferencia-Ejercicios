...
knitr::include_graphics("images/fmpBernouilli.png")
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/cdfBernouilli.png")
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/pmfUnifDiscreta.png")
```

```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/cdfUnifDiscreta.png")
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/pdfUnifContinua.png")
```
...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("images/cdfUnifContinua.png")
```
